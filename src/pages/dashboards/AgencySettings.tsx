...
export default function AgencySettings() {
  ...
  return (
    <DashboardLayout role="agency">
      <div className="mb-6">
        <h1 className="text-2xl font-black text-slate-900">Paramètres du cabinet</h1>
        <p className="text-slate-500 text-sm mt-0.5">Gérez les informations de votre cabinet et les accès de votre équipe</p>
      </div>
        ...
        <aside className="lg:w-64 flex-shrink-0">
          <div className="card overflow-hidden">
            <nav className="flex flex-col">
              {[
                { id: 'profile', label: 'Profil du cabinet', icon: Building2 },
              ...
              <div className="flex items-center gap-6 mb-8 pb-8 border-b border-slate-100">
                <div className="relative">
                  {companyLogo ? (
                    ...
                    <Avatar name={companyName || 'Cabinet'} size="xl" />
                  )}
                ...
                <div>
                  <h2 className="text-lg font-bold text-slate-900">Logo du cabinet</h2>
              ...
              <form onSubmit={handleProfileSave} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-slate-500 uppercase">Nom du cabinet</label>
                    <input
                      type="text"
                      value={companyName}
              ...
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">
                    {isTeamMember ? "Seul le compte principal peut gérer l'équipe" : 'Donnez accès aux recruteurs de votre cabinet'}
                  </p>
                </div>
                {!isTeamMember && (
