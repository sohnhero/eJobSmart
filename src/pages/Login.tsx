      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-900 via-brand-800 to-brand-700 relative overflow-hidden p-12 flex-col justify-between">
        ...
        <div className="relative">
          <Link to="/" className="flex items-center mb-12">
            <Logo variant="full" size={44} inverted />
          </Link>

          <h1 className="text-4xl font-black text-white leading-tight mb-4">
            Bienvenue<br />sur eJobSmart
          </h1>
          <p className="text-blue-200 text-lg leading-relaxed mb-10">
            La marketplace RH qui connecte les meilleurs talents aux meilleures opportunités en Afrique de l'Ouest.
          </p>
        ...
        <p className="relative text-xs text-blue-300">© 2026 eJobSmart — Plateforme RH Afrique de l'Ouest</p>
      </div>
